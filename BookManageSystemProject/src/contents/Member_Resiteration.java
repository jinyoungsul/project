...
class Member_Resiteration extends JDialog {
	...
	public Member_Resiteration(MemberContents memberContents) {
		...
		memberNo = dao.selectMemberNo();
		textField_1 = new JTextField((memberNo+1)+"");
